...
POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(os_icon context custom_internet_signal custom_battery_status_joined ram load ssh root_indicator dir dir_writable vcs)
